...
const analyzeText = (value = "") => {
  ...
  return {
    ...
    signals,
    recommendedActions,
    disclaimer: "Deterministic safety assessment. This is not proof that a person, number, message, or website is fraudulent.",
    fallback: false,
  };
};
...
const analyzeUrl = (rawUrl = "") => {
  ...
  try {
    ...
    return {
      ...
      disclaimer: "URL structure alone cannot prove that a website is safe or malicious.",
      fallback: false,
    };
  } catch {
