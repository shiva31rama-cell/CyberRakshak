...
const learnLimiter = rateLimit({ windowMs: 60 * 1000, limit: 120, standardHeaders: "draft-8", legacyHeaders: false, message: { success: false, message: "Too many learning requests. Please try again shortly." } });
...
app.use("/api/learn", learnLimiter, require("./routes/learn"));
